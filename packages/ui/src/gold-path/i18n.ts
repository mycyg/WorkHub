...
const goldPathCopy = {
  "zh-CN": {
    ...
    "home.entryText": "主线就是当前这一件事，专注处理它就好。",
    ...
    "settings.kicker": "设置",
    "settings.title": "应用设置",
    "settings.summary": "在这里管理运行、语言、预算和桌面客户端连接；桌宠形象在独立的桌宠窗口里设置。",
  ...
  "en-US": {
    ...
    "home.entryText": "The main path is this one thing right now — just focus and handle it.",
