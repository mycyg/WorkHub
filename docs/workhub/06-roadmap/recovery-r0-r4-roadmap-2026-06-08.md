...
| R4-mid review / R4.19-pre true React mount spike | **下一步前置硬门**：先证明真实 `createRoot` mount、delegated dispatcher 共存与 SSE 下 props update，不再用 marker/fingerprint 替代 React runtime。 | [`r4-mid-review-upgrade-audit-2026-06-11.md`](./r4-mid-review-upgrade-audit-2026-06-11.md)；[`r4-19-proposal-advanced-split-migration-plan-2026-06-11.md`](./r4-19-proposal-advanced-split-migration-plan-2026-06-11.md) |
| R4-19 Proposal advanced split migration | **R4.19-pre 通过后**：拆 Proposal readonly summary / advanced fallback boundary，并增加 dirty edit SSE guard 与 no-new-fixture-chrome gate。 | [`r4-19-proposal-advanced-split-migration-plan-2026-06-11.md`](./r4-19-proposal-advanced-split-migration-plan-2026-06-11.md) |
