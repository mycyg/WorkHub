...
| `r4-15-settings-locale-device-boundary-hardening-plan-2026-06-11.md` | **R4.15**:Settings / locale / device boundary hardening，统一语言偏好、桌面能力门、运行时状态和恢复动作 | planned |
