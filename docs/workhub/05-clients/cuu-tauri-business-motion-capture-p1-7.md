...
12. 下一步完成 Linux/macOS 策略：Windows 继续用 Win32 `PrintWindow` + UIA tray driver；Linux 仍需真实 GNOME/KDE/Xfce panel 才能证明 appindicator/tray menu 物理点击；macOS 需要记录透明窗口、menu bar restore 与截图权限。
