...
- 独立 Tauri `pet` window runtime；目前已有 webview `/pet` surface 分流、Rust window plan / config scaffold、pet 几何合同、command scaffold 和前端 bridge，但还没有真实 Tauri setup/runtime 执行。
