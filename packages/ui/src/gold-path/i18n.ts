...
const goldPathCopy = {
  "zh-CN": {
    ...
    "home.emptySummary": "需要你拿主意时，AI 会第一时间把它端到你面前，先安心忙别的吧 (=^･ω･^=)",
    ...
    "approvals.reasonFallback": "只有需要你拍板的事会排到这里。",
    ...
    "settings.runtimeBody": "在这里查看 AI 用哪个模型、能用哪些工具，以及最近的执行记录。",
    "settings.desktopTitle": "桌面客户端",
    "settings.desktopBody": "改本地文件、同步文件夹、托盘和桌宠窗口，都在桌面客户端里操作。",
    "settings.costTitle": "预算",
    "settings.costBody": "预算上限和当前花费在「成本」页查看；接近上限时会提醒你。",
    "settings.languageTitle": "语言",
    "settings.languageBody": "顶部可以切换界面语言。",
    ...
    "runtime.notice.desktopRequiredBody": "这一步需要访问本机或独立窗口，请到桌面客户端继续。",
  ...
  "en-US": {
    ...
    "approvals.reasonFallback": "Only items that need your decision land here.",
    ...
    "approvals.unrouted": "No approver assigned",
    ...
    "workitem.traceTitle": "How AI worked on this",
    ...
    "replay.diff3Current": "Changes in the current version",
    "replay.diff3Incoming": "Changes in this version",
    ...
    "settings.runtimeBody": "See which model AI uses, which tools it may call, and its recent runs.",
    "settings.desktopTitle": "Desktop client",
    "settings.desktopBody": "File changes on this machine, folder sync, the tray, and the pet window all live in the desktop app.",
    "settings.costTitle": "Budget",
    "settings.costBody": "Budgets and spend live on the Cost page; you get a warning as you approach a limit.",
    "settings.languageTitle": "Language",
    "settings.languageBody": "Switch the interface language from the top bar.",
    ...
    "runtime.notice.desktopRequiredBody": "This action needs local access or a separate window — continue in the desktop app.",
    ...
    "runtime.notice.fieldValueRequiredBody": "Enter a value first — an empty field won't be submitted.",
    "runtime.notice.intakeOptionRequiredTitle": "Choose an option first",
    "runtime.notice.intakeOptionRequiredBody": "Pick one of the options to continue.",
