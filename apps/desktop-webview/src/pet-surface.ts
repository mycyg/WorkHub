...
export const desktopPetSurfaceCss = [
  ...
  ".wh-pet-chip,.wh-pet-action,.wh-pet-reason{min-width:0;border:1px solid rgba(38,49,70,.14);border-radius:8px;background:#fff;padding:6px 8px;color:#222b38;font:800 12px/1.2 \"Aptos\",\"Segoe UI\",\"Microsoft YaHei\",\"PingFang SC\",\"Noto Sans CJK SC\",sans-serif;text-decoration:none;max-width:100%;overflow-wrap:anywhere;word-break:break-word;appearance:none}",
