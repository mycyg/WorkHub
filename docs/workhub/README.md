...
| `r4-16-react-route-tree-hydration-boundary-plan-2026-06-11.md` | **R4.16**:React route tree / hydration boundary，在不降低 Page VM、active-only 与 Settings boundary gates 的前提下迁移 route components | planned |
