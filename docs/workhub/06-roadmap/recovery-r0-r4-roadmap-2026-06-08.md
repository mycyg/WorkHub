...
| R4-15 Settings / locale / device boundary hardening | **下一步**：统一语言偏好、Settings route 状态、desktop-only 能力门与 recovery actions，继续保持主窗无 Cuu、无 secret 泄漏。 | [`r4-15-settings-locale-device-boundary-hardening-plan-2026-06-11.md`](./r4-15-settings-locale-device-boundary-hardening-plan-2026-06-11.md) |
