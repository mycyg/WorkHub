...
import { commandPaletteCopy } from "./command-palette/locales.js";
...
export const commandRegistry: DesktopCommand[] = [
  ...
  },
  {
    ...
    id: "notifications",
    ...commandPaletteCopy("notifications"),
  ...
  {
    id: "new_project",
    ...commandPaletteCopy("new_project"),
