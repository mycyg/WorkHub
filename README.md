...
- 📐 **规格树索引**:[`docs/workhub/`](docs/workhub/README.md) —— 103 篇(架构 / AI 引擎 / 协作 / 业务模块 / 客户端 / 路线图 / 成本治理 / 视觉 QA)
...
- 生产沙箱与 Agent 执行后续要求 Linux；桌面端已补 Windows 物理托盘、Linux GNOME StatusNotifier/AppIndicator 与 macOS menu bar 中英 smoke；Web R4.16 已补 route tree / hydration boundary browser smoke，后续继续推进真实 React route component migration 与最终跨平台打包验收。
