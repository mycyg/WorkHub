...
> **配对文档**：[`r9-agent-army-ux-flow-spec-2026-07-02.md`](./r9-agent-army-ux-flow-spec-2026-07-02.md)——流程织入与 UI/UX 规格（每个阶段的用户旅程/卡片文案/状态矩阵/验收清单）。工程切片开工前先读对应 surface 的 UX 规格；两文冲突时交互语义以 UX 规格为准。
