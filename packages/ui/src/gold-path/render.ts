...
import { describeCuuModelPackChoices, type CuuModelPackChoice } from "@workhub/cuu";
...
export const goldPathCss = [
  ...
  ".wh-settings-models{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px;margin-top:18px}.wh-model-option{display:grid;gap:10px;text-align:left;border:1px solid var(--line);background:#fff;border-radius:8px;padding:16px;color:var(--ink);font:700 14px/1.35 \"Aptos\",\"Segoe UI\",sans-serif}.wh-model-option[aria-pressed=true]{border-color:rgba(53,92,255,.38);box-shadow:inset 4px 0 0 var(--blue),0 0 0 1px rgba(53,92,255,.12);background:#f8fbff}.wh-model-option[disabled]{opacity:.62;cursor:not-allowed;background:#f8fafc}.wh-model-top{display:flex;align-items:center;justify-content:space-between;gap:10px}.wh-model-title{font-size:16px;font-weight:900}.wh-model-status{border-radius:999px;background:var(--soft);padding:4px 8px;color:var(--muted);font-size:12px;font-weight:850;white-space:nowrap}.wh-model-option[aria-pressed=true] .wh-model-status{background:rgba(53,92,255,.12);color:var(--blue)}.wh-model-action{justify-self:start;border-radius:8px;border:1px solid var(--line);background:#fff;padding:8px 10px;font-weight:850;color:var(--ink)}.wh-model-option[aria-pressed=true] .wh-model-action{background:var(--blue);border-color:var(--blue);color:#fff}",
  ".wh-cuu{display:grid;gap:14px;text-align:left}.wh-cuu-name{font-weight:800}.wh-cuu-figure{width:154px;height:166px;position:relative;display:grid;place-items:center;isolation:isolate}.wh-cuu-portrait{position:relative;z-index:4;width:146px;height:164px;object-fit:contain;filter:drop-shadow(0 16px 20px rgba(134,83,42,.18));animation:wh-cuu-breathe 2.8s ease-in-out infinite;transform-origin:50% 100%}.wh-cuu-figure[data-cuu-asset=bitmap] .wh-cuu-cat,.wh-cuu-figure[data-cuu-asset=bitmap] .wh-cuu-shadow{display:none}.wh-cuu-cat{position:relative;width:92px;height:88px;animation:wh-cuu-breathe 2.8s ease-in-out infinite;transform-origin:50% 100%}.wh-cuu-head{position:absolute;left:15px;top:10px;width:62px;height:58px;border-radius:48% 48% 44% 44%;background:linear-gradient(145deg,#ffb65e,#ee842f 72%);box-shadow:inset -8px -10px 0 rgba(166,82,30,.12),0 10px 24px rgba(194,103,36,.2);z-index:2}.wh-cuu-ear{position:absolute;top:0;width:25px;height:28px;background:#ef8732;clip-path:polygon(50% 0,100% 100%,0 100%);z-index:1}.wh-cuu-ear-left{left:17px;transform:rotate(-14deg)}.wh-cuu-ear-right{right:17px;transform:rotate(14deg)}.wh-cuu-ear:after{content:\"\";position:absolute;left:7px;top:9px;width:11px;height:13px;background:#ffd2bd;clip-path:polygon(50% 0,100% 100%,0 100%)}.wh-cuu-eye{position:absolute;top:23px;width:12px;height:15px;border-radius:50%;background:#1c2030;box-shadow:inset 3px 3px 0 rgba(255,255,255,.8)}.wh-cuu-eye-left{left:18px}.wh-cuu-eye-right{right:18px}.wh-cuu-muzzle{position:absolute;left:20px;top:37px;width:22px;height:15px;border-radius:50%;background:#ffe5c7}.wh-cuu-nose{position:absolute;left:28px;top:38px;width:7px;height:5px;border-radius:50%;background:#d6635e}.wh-cuu-body{position:absolute;left:20px;top:51px;width:58px;height:44px;border-radius:50% 50% 44% 44%;background:linear-gradient(140deg,#f6a34b,#dc7930);box-shadow:inset -8px -8px 0 rgba(143,72,26,.1)}.wh-cuu-tail{position:absolute;right:2px;top:52px;width:34px;height:42px;border:9px solid #e88734;border-left:0;border-bottom:0;border-radius:0 90% 0 0;transform:rotate(16deg);animation:wh-cuu-tail 2.4s ease-in-out infinite}.wh-cuu-collar{position:absolute;left:18px;top:63px;width:56px;height:13px;border-radius:999px;background:linear-gradient(90deg,#fff7f4,#f2dfd7);border:1px solid rgba(199,157,143,.55);z-index:3}.wh-cuu-bow{position:absolute;left:35px;top:65px;width:22px;height:13px;z-index:4}.wh-cuu-bow:before,.wh-cuu-bow:after{content:\"\";position:absolute;top:1px;width:11px;height:11px;background:#202436;border-radius:45% 10% 45% 10%}.wh-cuu-bow:before{left:0;transform:rotate(24deg)}.wh-cuu-bow:after{right:0;transform:scaleX(-1) rotate(24deg)}.wh-cuu-stripe{position:absolute;top:14px;width:4px;height:15px;border-radius:999px;background:rgba(153,76,31,.28);z-index:3}.wh-cuu-stripe-one{left:27px;transform:rotate(-16deg)}.wh-cuu-stripe-two{left:38px}.wh-cuu-stripe-three{right:27px;transform:rotate(16deg)}.wh-cuu-shadow{position:absolute;left:23px;right:23px;bottom:5px;height:12px;border-radius:50%;background:rgba(84,55,36,.14);filter:blur(2px);z-index:-1}.wh-cuu-figure[data-cuu-state=thinking] .wh-cuu-cat,.wh-cuu-figure[data-cuu-state=thinking] .wh-cuu-portrait,.wh-cuu-figure[data-cuu-state=searching_evidence] .wh-cuu-cat,.wh-cuu-figure[data-cuu-state=searching_evidence] .wh-cuu-portrait{animation:wh-cuu-think 1.5s ease-in-out infinite}.wh-cuu-figure[data-cuu-state=asking_approval] .wh-cuu-cat,.wh-cuu-figure[data-cuu-state=asking_approval] .wh-cuu-portrait,.wh-cuu-figure[data-cuu-state=carrying_document] .wh-cuu-cat,.wh-cuu-figure[data-cuu-state=carrying_document] .wh-cuu-portrait{animation:wh-cuu-hop 1.8s ease-in-out infinite}.wh-cuu-figure[data-cuu-state=celebrating] .wh-cuu-cat,.wh-cuu-figure[data-cuu-state=celebrating] .wh-cuu-portrait{animation:wh-cuu-celebrate 1.1s ease-in-out infinite}.wh-cuu-figure[data-cuu-state=worried] .wh-cuu-cat,.wh-cuu-figure[data-cuu-state=worried] .wh-cuu-portrait{animation:wh-cuu-worry .9s ease-in-out infinite}.wh-progress{height:8px;border-radius:999px;background:#e7ecf6;overflow:hidden}.wh-progress>span{display:block;height:100%;background:var(--blue)}",
...
function cuuRail(input: {
  ...
  return `<aside class="wh-panel wh-side wh-cuu">
    <div class="wh-cuu-figure" data-cuu-state="${escapeHtml(input.state)}" data-cuu-asset="bitmap" aria-hidden="true">
      <img class="wh-cuu-portrait" src="./assets/cuu/cuu-polished-idle-v1-alpha.png" alt="" decoding="async" onerror="this.hidden=true;this.parentElement.setAttribute('data-cuu-asset','css')">
...
function settingsModelTitle(packId: string, locale: WorkHubLocale) {
  if (packId === "cuu-live2d-cubism-v2") {
    return t(locale, "settings.live2d");
  }
  return t(locale, "settings.defaultCat");
}

function settingsModelStatus(choice: CuuModelPackChoice, locale: WorkHubLocale) {
  return choice.status === "default_ready"
    ? t(locale, "settings.currentDefault")
    : t(locale, "settings.experimentalLocked");
}

function settingsModelReason(choice: CuuModelPackChoice, locale: WorkHubLocale) {
  return choice.status === "default_ready"
    ? t(locale, "settings.bongoReason")
    : t(locale, "settings.live2dReason");
}

function renderSettingsModelChoice(choice: CuuModelPackChoice, locale: WorkHubLocale) {
  const disabled = choice.can_select_in_settings ? "" : " disabled";
  return `<button class="wh-model-option" type="button" data-cuu-settings-model-pack-id="${escapeHtml(choice.pack_id)}" data-cuu-settings-model-pack-status="${escapeHtml(choice.status)}" data-cuu-settings-model-pack-selectable="${choice.can_select_in_settings ? "true" : "false"}" aria-pressed="${choice.selected ? "true" : "false"}"${disabled}>
    <span class="wh-model-top"><span class="wh-model-title">${escapeHtml(settingsModelTitle(choice.pack_id, locale))}</span><span class="wh-model-status">${escapeHtml(settingsModelStatus(choice, locale))}</span></span>
    <span class="wh-subtle">${escapeHtml(settingsModelReason(choice, locale))}</span>
    <span class="wh-model-action">${escapeHtml(choice.can_select_in_settings ? t(locale, "settings.pick") : t(locale, "settings.locked"))}</span>
  </button>`;
}

function renderSettings(surface: GoldPathRenderSurface, locale: WorkHubLocale): GoldPathRenderedPage {
  const choices = describeCuuModelPackChoices();
  const main = `<span class="wh-kicker">${escapeHtml(t(locale, "settings.kicker"))}</span>
    ...
    <div class="wh-settings-models">${choices.map((choice) => renderSettingsModelChoice(choice, locale)).join("")}</div>
    <div class="wh-grid">
      <article class="wh-card"><strong>${escapeHtml(t(locale, "settings.handfeelTitle"))}</strong><p class="wh-subtle">${escapeHtml(t(locale, "settings.handfeelBody"))}</p></article>
  ...
  return {
    ...
    route: "/settings",
    title: "Cuu Settings",
    html: pageShell(surface, "Cuu Settings", main, cuuRail({ state: "idle", locale })),
    primaryHrefs: [],
    cuuState: "idle"
  };
}
