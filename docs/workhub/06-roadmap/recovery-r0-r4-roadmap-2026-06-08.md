...
| R4-12 action/notice locale route UX | **下一步**：把 proposal opened/merged、approval response、budget warning、retry/request access、SSE refresh notice 纳入统一中英 action feedback contract。 | [`r4-12-web-action-notice-locale-route-ux-plan-2026-06-11.md`](./r4-12-web-action-notice-locale-route-ux-plan-2026-06-11.md) |
