...
const desktopCuuBongoCss = [
  ...
  ".wh-pet-surface[data-pet-cursor-near=true] .wh-cuu-bongo[data-cuu-bongo-state=look_at_mouse] .wh-cuu-bongo-head{animation:none;transform:translate(var(--wh-pet-look-head-x-px,0px),var(--wh-pet-look-head-y-px,0px)) rotate(var(--wh-pet-look-rotate-deg,0deg))}",
  ".wh-pet-surface[data-pet-cursor-near=true] .wh-cuu-bongo[data-cuu-bongo-state=look_at_mouse] .wh-cuu-bongo-eye{animation:none;transform:translate(var(--wh-pet-look-eye-x-px,0px),var(--wh-pet-look-eye-y-px,0px)) scaleY(1)}",
  ".wh-pet-surface[data-pet-cursor-near=true] .wh-cuu-bongo[data-cuu-bongo-state=look_at_mouse] .wh-cuu-bongo-nose,.wh-pet-surface[data-pet-cursor-near=true] .wh-cuu-bongo[data-cuu-bongo-state=look_at_mouse] .wh-cuu-bongo-mouth{transform:translate(var(--wh-pet-look-face-x-px,0px),var(--wh-pet-look-face-y-px,0px))}",
  ".wh-pet-surface[data-pet-hover-avoidance=soft] .wh-cuu-bongo[data-cuu-bongo-state=look_at_mouse] .wh-cuu-bongo-whisker-l{transform:translateX(var(--wh-pet-look-face-x-px,0px)) rotate(8deg)}",
  ".wh-pet-surface[data-pet-hover-avoidance=soft] .wh-cuu-bongo[data-cuu-bongo-state=look_at_mouse] .wh-cuu-bongo-whisker-r{transform:translateX(var(--wh-pet-look-face-x-px,0px)) rotate(-8deg)}",
