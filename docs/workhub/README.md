...
| `r4-11-web-route-componentization-second-slice-plan-2026-06-11.md` | **R4.11**:WorkItem/Proposal/Cost/Settings route componentization second slice 计划、active-only panel 与 no-overflow gates 延续 | current |
