...
export const teamCalendarCss = [
  ...
  ".wh-tcal-title{margin:0;font-size:20px;font-weight:900;color:#1d1d1f}",
  ".wh-tcal-range{font:700 13px/1 'Noto Sans SC',sans-serif;color:#8e8e93;margin-left:10px}",
  ".wh-tcal-chips{display:flex;gap:8px;flex-wrap:wrap}",
  ".wh-tcal-chip{font:700 12px/1 'Noto Sans SC',sans-serif;color:#636366;background:rgba(255,255,255,.55);border:1px solid rgba(255,255,255,.7);border-radius:11px;padding:7px 11px}.wh-tcal-chip b{color:#0a84ff;font-size:14px;margin-right:4px}",
  ".wh-tcal-chip--alert{background:rgba(255,69,58,.14);border-color:rgba(255,69,58,.30)}.wh-tcal-chip--alert b{color:#ff453a}",
  ".wh-tcal-days{display:flex;flex-direction:column;gap:16px}",
  ".wh-tcal-day{border-radius:22px;overflow:hidden;background:rgba(255,255,255,.55);backdrop-filter:blur(32px) saturate(180%);-webkit-backdrop-filter:blur(32px) saturate(180%);border:1px solid rgba(255,255,255,.75);box-shadow:0 26px 58px -30px rgba(60,60,67,.32),inset 0 1px 0 rgba(255,255,255,.75)}",
  ".wh-tcal-dayhead{display:flex;align-items:center;gap:10px;padding:14px 20px 10px}",
  ".wh-tcal-daydate{font:800 14px/1 'M PLUS Rounded 1c','Noto Sans SC',sans-serif;color:#1d1d1f}",
  ".wh-tcal-today{font:800 10px/1 'Noto Sans SC',sans-serif;color:#fff;background:linear-gradient(135deg,#0a84ff,#64d2ff);border-radius:7px;padding:4px 8px}",
  ".wh-tcal-blocks{display:flex;flex-direction:column}",
  ".wh-tcal-block{display:flex;gap:14px;padding:13px 20px;border-top:1px solid rgba(10,132,255,.10);text-decoration:none}",
  ".wh-tcal-block--link{cursor:pointer;transition:background .15s ease}.wh-tcal-block--link:hover{background:rgba(10,132,255,.08)}",
  ".wh-tcal-time{flex:0 0 52px;font:800 13px/1.5 'M PLUS Rounded 1c',sans-serif;color:#0a84ff;padding-top:2px}",
  ...
  ".wh-tcal-tag{font:800 10px/1 'M PLUS Rounded 1c','Noto Sans SC',sans-serif;color:#0a84ff;background:rgba(10,132,255,.14);border-radius:7px;padding:4px 7px}",
  ".wh-tcal-tag--due{color:#ff9f0a;background:rgba(255,159,10,.16)}",
  ".wh-tcal-tag--meeting{color:#30d158;background:rgba(48,209,88,.16)}",
  ".wh-tcal-tag--review{color:#64d2ff;background:rgba(100,210,255,.16)}",
  ".wh-tcal-status{font:700 10px/1 'Noto Sans SC',sans-serif;color:#8e8e93}",
  ".wh-tcal-status--today{color:#0a84ff}",
  ".wh-tcal-status--overdue{color:#ff453a}",
  ".wh-tcal-status--done{color:#30d158}",
  ".wh-tcal-block-title{font:700 14.5px/1.45 'Noto Sans SC',sans-serif;color:#1d1d1f;overflow-wrap:anywhere}",
  ".wh-tcal-block-desc{font:500 12.5px/1.5 'Noto Sans SC',sans-serif;color:#636366;overflow-wrap:anywhere}",
