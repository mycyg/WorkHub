...
| R4-13 Proposal advanced route UX convergence | **下一步**：把 conflict workbench、field editor、line editor、subrecord editor 收敛到 Proposal active-only route component，并复用 R4.12 notice gates。 | [`r4-13-proposal-advanced-route-ux-convergence-plan-2026-06-11.md`](./r4-13-proposal-advanced-route-ux-convergence-plan-2026-06-11.md) |
