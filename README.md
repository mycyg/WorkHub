...
- 📐 **规格树索引**:[`docs/workhub/`](docs/workhub/README.md) —— 154 篇(架构 / AI 引擎 / 协作 / 业务模块 / 客户端 / 路线图 / 成本治理 / 视觉 QA)
...
| S1 Day 3 | observe-ready ✅ | `qa:s1-day3-preflight` 与 `qa:s1-day3-observation` 已准备：队列干净，metrics 可比，等待 1-3 位真实使用者进入 `/intake`。 |
