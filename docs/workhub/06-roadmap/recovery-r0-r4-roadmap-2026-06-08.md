...
| R4-3 多记录真实数据 | 去除单硬编码“客户周报”假场景，接 R1/R2 seed 或 PG smoke 生成多 work_item/proposal/approval/cost usage 的 ready 截图。 | 多条真实数据渲染 + route visual report |
