...
| `r4-18-react-route-migration-expansion-plan-2026-06-11.md` | **R4.18**:React route migration expansion，计划把 Cost / Replay 接入同一 component adapter，并保留 R4.17 gates | planned |
