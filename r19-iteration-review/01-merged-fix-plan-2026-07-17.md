...
消息 outbox/replay(P2-01)、offboarding 可重入 job(P2-02)、审计写入不静默吞(P2-03)、语言偏好同步提示(P2-09)、头像弹窗焦点生命周期(P2-10)、Chrome QA 日志(P2-11)、cargo fmt/clippy 清零并进 CI(P3-01)、预算续租可观测(P3-02)、数据层孤儿表处置(R19-7/34-37)、死枚举清理(R19-38/29/30)、R19 低危 UX 清单其余项。
