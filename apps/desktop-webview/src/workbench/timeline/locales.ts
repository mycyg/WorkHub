...
const zh = {
  ...
  create: "新建",
  createAFewMilestonesThenAttach: "先建几个里程碑，再把任务挂上去、连出依赖，就能看到排期条和关键路径。",
  deleteMilestone: "删除里程碑",
  deleteThisMilestoneItsWorkItems: "删除这个里程碑？挂在它下面的任务会变回未挂里程碑。",
  dueDate: "截止日期",
  editMilestone: "编辑里程碑",
  ...
  noWorkItemsHaveStartDue: "还没有任务带开始/截止日期——填上日期后这里会画出排期条。",
...
const en = {
  ...
  create: "Create",
  createAFewMilestonesThenAttach: "Create a few milestones, then attach tasks and link dependencies to see the schedule and critical path.",
  deleteMilestone: "Delete milestone",
  deleteThisMilestoneItsWorkItems: "Delete this milestone? Its tasks go back to unassigned.",
  dueDate: "Due date",
  ...
  noWorkItemsHaveStartDue: "No tasks have start/due dates yet — add dates to draw the schedule bars.",
  noWorkItemsUnderThisMilestone: "No tasks under this milestone",
  reached: "Reached",
