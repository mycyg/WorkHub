...
| `r4-13-proposal-advanced-route-ux-convergence-plan-2026-06-11.md` | **R4.13**:Proposal advanced route UX convergence，conflict workbench、field/line/subrecord editor 收敛到 active-only route component | planned |
