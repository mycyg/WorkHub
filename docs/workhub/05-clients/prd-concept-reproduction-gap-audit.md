...
2. **Bongo P1d-b / P1e-d 动作与窗口体验**：P1d-a 已补缩放、透明度和点击穿透契约，P1e-a/P1e-b/P1e-c 已补 cursor-near、pointer DOM attrs、hover/tap/drag、连续看鼠标和 hover 避让真实录屏；下一步补真实 Tauri 设置截图、hide-on-hover、多屏恢复、显示/隐藏快捷入口、pointer smoothing / drag grip 细抛光，并加大抱文件 / 审批敲桌 / 完成庆祝的动作幅度。
