...
| R4-19 Proposal advanced split migration | **下一步**：拆 Proposal readonly summary / advanced fallback boundary，并增加 dirty edit SSE guard 与 no-new-fixture-chrome gate。 | [`r4-19-proposal-advanced-split-migration-plan-2026-06-11.md`](./r4-19-proposal-advanced-split-migration-plan-2026-06-11.md) |
