...
test("memory conflict attention cards expose concrete resolution actions", () => {
  ...
  assert.deepEqual(
    ...
    [
      ["keep_current", "POST", `/api/memory-conflicts/${conflictId}/resolve/keep_current`],
      ["accept_incoming", "POST", `/api/memory-conflicts/${conflictId}/resolve/accept_incoming`],
      ["merge_both", "POST", `/api/memory-conflicts/${conflictId}/resolve/merge_both`],
