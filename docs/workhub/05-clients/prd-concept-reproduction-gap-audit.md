...
| WEB-P3 | `/proposals/:id` | 多类型交付物变更说明、预览、结构化字段落点和后续字段级编辑 |
| WEB-P4 | `/knowledge` / Cuu search | Web 做兜底，Cuu 气泡做默认入口 |
| WEB-P5 | `/dashboard/cost` | P-COST Usage / BudgetNotice / CostSummaryVM 接真实数据 |
| WEB-P6 | `/agent-runs/:id/replay` | 真实 trace、accepted deliverables、merge timeline、字段写回审计与 eval/replay 对齐 |
