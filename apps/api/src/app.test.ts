...
test("GET /api/openapi.json exposes the headless daemon contract seed", async () => {
  ...
  const expectedRoutes = [
    ...
    ["get", "/api/search"],
    ["get", "/api/me/memories"],
    ["get", "/api/me/memories/{id}"],
    ["patch", "/api/me/memories/{id}"],
    ["delete", "/api/me/memories/{id}"],
    ["get", "/api/team-skills/manage"],
    ["get", "/api/team-skills/manage/{id}"],
    ["patch", "/api/team-skills/manage/{id}"],
    ["post", "/api/team-skills/manage/{id}/deactivate"],
    ["put", "/api/conversations/{id}/messages/{messageId}/feedback"],
    ["delete", "/api/conversations/{id}/messages/{messageId}/feedback"],
    ["put", "/api/proposals/{id}/feedback"],
    ["delete", "/api/proposals/{id}/feedback"],
    ["put", "/api/action-card-items/{id}/feedback"],
    ["delete", "/api/action-card-items/{id}/feedback"],
    ["get", "/api/projects/{id}/github-binding"],
    ["put", "/api/projects/{id}/github-binding"],
    ["delete", "/api/projects/{id}/github-binding"],
    ["post", "/api/projects/{id}/github-binding/test"],
