...
S1-D1  Feedback + Observability            ← active-day1：1-3 人真实反馈、六指标采集、每日 ops loop
S1     Pilot Week（Day 1 反馈观测固化后扩大；turnkey 运营手册已进入 active-day1）
...
| **S1 Day 1** | 固化反馈入口、每日指标快照、第二用户路径、ops loop、Day1 backup/restore | 不新增业务模块；不并行开桌宠新面 |
