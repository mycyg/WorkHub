...
const accentByTone: Record<DeckTagTone, string> = {
  approval: "linear-gradient(90deg,#0a84ff,#64d2ff)",
  choice: "linear-gradient(90deg,#0a84ff,#30d158)",
  permission: "linear-gradient(90deg,#30d158,#64d2ff)",
  handoff: "linear-gradient(90deg,#ff453a,#ff9f0a)",
  info: "linear-gradient(90deg,#8e8e93,#d1d1d6)"
};
...
export const decisionDeckCss = [
  ...
  ".wh-deck-worklog-text{font:700 13px/1.5 'Noto Sans SC',sans-serif;color:#636366;overflow-wrap:anywhere}.wh-deck-worklog-text b{color:#0a84ff;font-weight:900}",
  ".wh-deck-worklog-evolve{color:#30d158}",
  ".wh-deck-stack{position:relative;min-height:240px}",
  ".wh-deck-peek{position:absolute;left:0;right:0;top:0;height:100%;border-radius:24px;border:1px solid rgba(255,255,255,.6);background:rgba(255,255,255,.4);box-shadow:0 18px 40px -26px rgba(60,60,67,.28)}",
  ...
  ".wh-deck-card{position:relative;z-index:3;border-radius:24px;overflow:hidden;background:rgba(255,255,255,.6);backdrop-filter:blur(34px) saturate(185%);-webkit-backdrop-filter:blur(34px) saturate(185%);border:1px solid rgba(255,255,255,.8);box-shadow:0 30px 66px -28px rgba(60,60,67,.34),inset 0 1px 0 rgba(255,255,255,.8)}",
  ...
  ".wh-deck-tag{font:800 11px/1 'M PLUS Rounded 1c','Noto Sans SC',sans-serif;color:#0a84ff;background:rgba(10,132,255,.14);border-radius:8px;padding:5px 9px}",
  ".wh-deck-tag--permission{color:#30d158;background:rgba(48,209,88,.16)}",
  ".wh-deck-tag--handoff{color:#ff453a;background:rgba(255,69,58,.14)}",
  ".wh-deck-tag--info{color:#636366;background:rgba(255,255,255,.6)}",
  ".wh-deck-count{font:800 12px/1 'M PLUS Rounded 1c','Noto Sans SC',sans-serif;color:#8e8e93}.wh-deck-count b{color:#0a84ff;font-size:15px}",
  ".wh-deck-title{margin:15px 0 0;font-size:19px;line-height:1.4;font-weight:800;color:#1d1d1f;overflow-wrap:anywhere}",
  ".wh-deck-desc{margin:13px 0 0;font-size:14px;line-height:1.6;color:#3a3a3c;overflow-wrap:anywhere}",
  ".wh-deck-actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:22px}",
  ".wh-deck-btn{border:1px solid rgba(255,255,255,.8);border-radius:14px;background:rgba(255,255,255,.5);color:#3a3a3c;font:700 14px/1 'Noto Sans SC',sans-serif;padding:13px 16px;cursor:pointer;text-decoration:none;display:inline-flex;align-items:center}",
  ".wh-deck-btn--primary{flex:1;min-width:120px;justify-content:center;border:0;background:linear-gradient(135deg,#0a84ff,#64d2ff);color:#fff;font-weight:800;box-shadow:0 14px 26px -8px rgba(10,132,255,.45)}",
  ".wh-deck-btn--danger{border-color:rgba(255,69,58,.32);color:#ff453a;font-weight:800}",
  ".wh-deck-btn--quiet{background:rgba(255,255,255,.4);color:#8e8e93}",
  ...
  ".wh-deck-cuu-line{font:700 13.5px/1.4 'Noto Sans SC',sans-serif;color:#636366;background:rgba(255,255,255,.55);border:1px solid rgba(255,255,255,.7);border-radius:14px;border-bottom-left-radius:4px;padding:9px 14px}",
  ...
  ".wh-deck-done-title{margin:18px 0 0;font-size:21px;font-weight:900;color:#1d1d1f}",
  ".wh-deck-done-sub{margin:10px 0 0;font-size:14px;line-height:1.6;color:#636366}",
  ...
  ".wh-deck-runs-label{display:flex;align-items:center;gap:8px;font:800 12px/1 'M PLUS Rounded 1c','Noto Sans SC',sans-serif;color:#636366}",
  ".wh-deck-runs-spark{font-size:15px}",
  ".wh-deck-runs-list{display:flex;flex-wrap:wrap;gap:8px;margin-top:10px}",
  ".wh-deck-run{display:inline-flex;align-items:center;gap:7px;max-width:100%;font:700 12px/1.3 'Noto Sans SC',sans-serif;color:#3a3a3c;background:rgba(255,255,255,.6);border:1px solid rgba(255,255,255,.7);border-radius:10px;padding:6px 10px}",
  ".wh-deck-run-dot{flex:0 0 auto;width:7px;height:7px;border-radius:50%;background:linear-gradient(135deg,#0a84ff,#30d158);box-shadow:0 0 0 3px rgba(10,132,255,.14)}",
  ".wh-deck-run-title{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:200px}",
  ".wh-deck-run-more{display:inline-flex;align-items:center;font:800 12px/1 'M PLUS Rounded 1c',sans-serif;color:#8e8e93;padding:6px 8px}"
].join("");
