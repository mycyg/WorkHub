...
| R4-11 route componentization second slice | **下一步**：拆 WorkItem / Proposal / Cost / Settings route components，保留 active-only panel、Page VM metrics、双语 fixed copy 与 no-overflow gates。 | [`r4-11-web-route-componentization-second-slice-plan-2026-06-11.md`](./r4-11-web-route-componentization-second-slice-plan-2026-06-11.md) |
