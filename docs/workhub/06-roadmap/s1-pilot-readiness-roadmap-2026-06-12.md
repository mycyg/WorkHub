...
S1-D0  Day 0 Real Work Entry               ← active：真实用户 UI 发起工作/项目种子、主持人可见闭环、Day0 backup/restore
S1     Pilot Week（Day 0 真实入口全绿后启动；turnkey 运营手册已立 s1-pilot-week-runbook）
...
| **S1 Day 0** | 真实用户从 UI 发起工作/项目种子的可见入口，主持人可见闭环，Day0 backup/restore | 不邀请多人；不扩业务面 |
