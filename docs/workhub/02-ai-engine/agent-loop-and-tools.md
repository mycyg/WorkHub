...
后续施工进入 R3 Cuu 出站 Agent 入口；完整审批中心、真实 React route 产品化与预算事件/Cuu budget bubble 继续按 R4/R5 展开。R2.6 细节见 [`r2-recovery-rest-auth.md`](./r2-recovery-rest-auth.md)，R2.7 gate 见 [`r2-release-gate.md`](./r2-release-gate.md)。
