...
2. **Bongo P1d-b 动作与窗口体验**：P1d-a 已补缩放、透明度和点击穿透契约；下一步补真实 Tauri 设置截图、hide-on-hover、hover 避让、多屏恢复、显示/隐藏快捷入口，并加大抱文件 / 审批敲桌 / 完成庆祝的动作幅度。
