...
export const proposalCss = [
  ":root{color-scheme:light;--ink:#1A1D26;--muted:#646E7E;--line:#E6E7EB;--paper:#fff;--soft:#F5F5FE;--blue:#4F46E5;--green:#15A05A;--coral:#ee6b5f;--amber:#E0892A;--danger:#E5484D}",
  ".wh-proposal{font-family:\"Aptos\",\"Segoe UI\",sans-serif;color:var(--ink);background:transparent;padding:24px;box-sizing:border-box}",
  ...
  ".wh-proposal-main,.wh-proposal-rail{background:rgba(255,255,255,.62);backdrop-filter:saturate(1.45) blur(18px);-webkit-backdrop-filter:saturate(1.45) blur(18px);border:1px solid rgba(255,255,255,.72);border-radius:18px;box-shadow:0 18px 50px rgba(37,51,79,.08);min-width:0}",
  ...
  ".wh-card{border:1px solid rgba(255,255,255,.75);background:rgba(255,255,255,.66);border-radius:16px;padding:16px;min-width:0;overflow-wrap:anywhere}.wh-row{display:flex;justify-content:space-between;gap:14px;border-top:1px solid var(--line);padding:12px 0}.wh-row:first-child{border-top:0}.wh-row>div{min-width:0}",
