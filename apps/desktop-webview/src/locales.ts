...
const zh = {
  ...
  checkThatTheInviteTokenNickname: "请检查邀请码、昵称和密码是否有效（密码至少 8 位）。",
  ...
  pasteTheInviteTokenYourAdmin: "粘贴管理员发给你的邀请码",
  ...
  thisDeviceHasnTConnectedTo: "这台设备第一次连接这台服务器：登录已有账号、注册新账号，或用邀请码加入。",
...
const en = {
  ...
  checkThatTheInviteTokenNickname: "Check that the invite code, nickname, and password are valid (password needs at least 8 characters).",
  ...
  enterTheInviteTokenNicknameAnd: "Enter the invite code, nickname, and password.",
  ...
  haveAnInviteToken: "Have an invite code",
  ...
  pasteTheInviteTokenYourAdmin: "Paste the invite code your admin sent you",
  ...
  thisDeviceHasnTConnectedTo: "This device hasn't connected to this server before — sign in, register, or join with an invite code.",
