...
- 📐 **规格树索引**:[`docs/workhub/`](docs/workhub/README.md) —— 101 篇(架构 / AI 引擎 / 协作 / 业务模块 / 客户端 / 路线图 / 成本治理 / 视觉 QA)
...
- 生产沙箱与 Agent 执行后续要求 Linux；桌面端已补 Windows 物理托盘、Linux GNOME StatusNotifier/AppIndicator 与 macOS menu bar 中英 smoke；Web R4.15 已补 Settings / locale / device boundary browser smoke，后续继续推进 React route tree / hydration boundary 与最终跨平台打包验收。
