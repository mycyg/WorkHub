...
| R4-23 Proposal line editor React migration | **已落 R4.23**：Proposal line editor 的 hunk decision/search/current file scope 已成为第二段真实可见 React mutation island，payload parity、dirty SSE guard、single dispatcher 与 HTML fallback boundary 均通过。 | [`r4-23-proposal-line-editor-react-migration-plan-2026-06-11.md`](./r4-23-proposal-line-editor-react-migration-plan-2026-06-11.md) |
| R4-24 Web runtime finalization | **已落 R4.24**：生产导航不再写 hash route，legacy `#/` 只在启动/链接 canonicalization 转 path；README 状态治理、browser smoke CI 拆分计划与 R5.1 Drive 决策均落地。 | [`r4-24-web-runtime-finalization-plan-2026-06-11.md`](./r4-24-web-runtime-finalization-plan-2026-06-11.md) |
| R5-1 Drive business slice | **下一步**：从 M-DRIVE 做第一条业务纵切，承接 accepted deliverables、Drive versions、preview/download/restore 与 OQ-4 文档合并语义。 | [`r5-01-drive-business-slice-decision-2026-06-11.md`](./r5-01-drive-business-slice-decision-2026-06-11.md) |
