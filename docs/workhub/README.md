...
| `r4-17-react-route-component-first-migration-plan-2026-06-11.md` | **R4.17**:React route component first migration，从低风险 route 开始迁移真实 React-compatible components，保留 HTML fallback 与 delegated action contract | planned |
