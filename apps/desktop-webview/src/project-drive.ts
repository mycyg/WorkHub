...
export const projectDriveCss = [
  ...
  ".wh-pdrive-back{border:1px solid rgba(255,255,255,.8);border-radius:12px;background:rgba(255,255,255,.5);color:#3a3a3c;font:800 13px/1 'Noto Sans SC',sans-serif;padding:9px 14px;cursor:pointer;backdrop-filter:blur(20px) saturate(160%);-webkit-backdrop-filter:blur(20px) saturate(160%)}",
  ...
  ".wh-pdrive-title{margin:0;font-size:20px;font-weight:900;color:#1d1d1f;overflow-wrap:anywhere}",
  ".wh-pdrive-chips{display:flex;gap:8px;flex-wrap:wrap}",
  ".wh-pdrive-chip{font:700 12px/1 'Noto Sans SC',sans-serif;color:#636366;background:rgba(255,255,255,.55);border:1px solid rgba(255,255,255,.7);border-radius:11px;padding:7px 11px}.wh-pdrive-chip b{color:#0a84ff;font-size:14px;margin-right:4px}",
  ".wh-pdrive-chip--accent b{color:#30d158}",
  ".wh-pdrive-list{border-radius:20px;overflow:hidden;background:rgba(255,255,255,.55);backdrop-filter:blur(32px) saturate(180%);-webkit-backdrop-filter:blur(32px) saturate(180%);border:1px solid rgba(255,255,255,.75);box-shadow:0 24px 54px -30px rgba(60,60,67,.32),inset 0 1px 0 rgba(255,255,255,.75)}",
  ".wh-pdrive-row{display:flex;align-items:center;gap:11px;padding:12px 18px;border-top:1px solid rgba(10,132,255,.10)}",
  ...
  ".wh-pdrive-name{flex:1;min-width:0;font:600 14px/1.4 'Noto Sans SC',sans-serif;color:#1d1d1f;overflow-wrap:anywhere}",
  ".wh-pdrive-meta{flex:0 0 auto;font:700 12px/1 'M PLUS Rounded 1c','Noto Sans SC',sans-serif;color:#8e8e93;white-space:nowrap}",
  ...
  ".wh-pdrive-empty-title{margin:16px 0 0;font-size:19px;font-weight:900;color:#1d1d1f}",
  ".wh-pdrive-empty-sub{margin:10px 0 0;font-size:13.5px;line-height:1.6;color:#636366}"
].join("");
