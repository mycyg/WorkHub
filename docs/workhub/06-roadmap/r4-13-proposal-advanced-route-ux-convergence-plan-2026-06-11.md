...
R4.14 已完成 Option Intake / Knowledge fallback route componentization：option-first intake、knowledge search fallback 和 workitem creation 已串成真实 route dataflow，同时保留 R4.12/R4.13 的 action feedback 与 no-overflow gates。R4.15 已完成 Settings / locale / device boundary hardening，详细记录见 [`r4-15-settings-locale-device-boundary-hardening-plan-2026-06-11.md`](./r4-15-settings-locale-device-boundary-hardening-plan-2026-06-11.md)。R4.16 已完成 React route tree / hydration boundary，计划与验收记录见 [`r4-16-react-route-tree-hydration-boundary-plan-2026-06-11.md`](./r4-16-react-route-tree-hydration-boundary-plan-2026-06-11.md)。后续进入 R4.17 route component first migration，计划见 [`r4-17-react-route-component-first-migration-plan-2026-06-11.md`](./r4-17-react-route-component-first-migration-plan-2026-06-11.md)。
