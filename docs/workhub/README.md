...
| `r4-20-dataflow-foundation-plan-2026-06-11.md` | **R4.20**:Dataflow foundation，计划集中处理 app 级 SSE 长连接、Page VM 局部 refetch、Last-Event-ID/事件 cursor 与 fixture chrome 退役 | planned |
