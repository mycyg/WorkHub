...
| `r4-12-web-action-notice-locale-route-ux-plan-2026-06-11.md` | **R4.12**:Web action/notice locale route UX 计划，覆盖 proposal/approval/budget/retry/SSE refresh feedback | planned |
