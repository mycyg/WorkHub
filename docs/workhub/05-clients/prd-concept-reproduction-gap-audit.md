...
| WEB-P3 | `/proposals/:id` | 多类型交付物变更说明、预览、结构化字段落点、标量字段高级编辑、子记录逐项 diff/editor、任务 plan 选择、折叠多冲突批量检查；R1.39 已补真实 route 富 preview、长 patch、移动端与截图门，R1.40 已补多 plan `task_items` 写回前点选目标 plan；后续补批量执行/审计产品化 |
