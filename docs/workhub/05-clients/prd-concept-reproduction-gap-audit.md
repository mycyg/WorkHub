...
| 变更申请像 GitHub PR，但对象多样 | Manifest fixture、proposal page、accepted deliverable ledger、冲突 gate、AI fusion candidate、一键 apply、text/spec 正文直写、真实三方文本上下文、数据层 patch preview 与 Replay patch preview 有基础 | 文档/PPT/表格/图片/文件夹预览、证据引用、自动 text diff3、Proposal 采用前富 patch viewer、字段级结构化 patch 与多冲突工作台 |
