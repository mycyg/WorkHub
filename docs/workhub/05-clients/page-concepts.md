...
Cuu 当前已有卡片适配、motion hints、procedural sprite runtime、controller 策略 MVP、desktop badge / 队列推进和审批/澄清动作提交基础；仍缺正式小猫动画资产、Rive/Live2D 高表现力路线、独立 pet window、拖拽/位置记忆、系统通知和展开气泡卡。
