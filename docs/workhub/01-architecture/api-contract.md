...
| **[新]** `POST /api/merge-proposals/{id}/apply` | `{confirm?: true}` | `ProposalMergeResult`；仅允许已选择的 `ai_fusion`，会物化 Markdown 融合稿并写入正式 accepted deliverable / Drive version / merge audit | reviewer |
