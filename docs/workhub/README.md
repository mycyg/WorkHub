...
| `r4-19-proposal-advanced-split-migration-plan-2026-06-11.md` | **R4.19**:Proposal advanced split migration，计划先迁 readonly summary / conflict boundary，mutation-heavy editors 保留 fallback；开工前先过中期审查的 R4.19-pre spike 与新 gate | planned |
